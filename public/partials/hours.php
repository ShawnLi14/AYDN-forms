	...
	<div class="container">
		...
		<div class="row">
			...
			<select class="form-select" aria-label="Event" id="event_type" name="event_type">
			...
			<input type="number" id="hours" name="hours" class="form-control hour" required>
			<label class="form-label" for="extra_hours">Extra Hour(s)</label>
			<input type="number" id="extra_hours" name="extra_hours" class="form-control hour">
			<label class="form-label" for="total_hours">Total Hour(s)</label>
			<input type="number" id="total_hours" name="total_hours" class="form-control hour">
